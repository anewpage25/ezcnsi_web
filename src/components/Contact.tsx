    ...
    <section id="contact" className="snap-section relative flex flex-col justify-between pt-24 pb-8 bg-navy-900">
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex-grow flex flex-col justify-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="p-8 flex-grow">
              <div className="mb-6 h-12 md:h-14">
                <img src="https://cdn.imweb.me/upload/S202412123c3b63e7f7510/2c9cf723b705a.png" alt="(주)이지씨엔에스아이 로고 - 공공 정보화 및 인공지능 시스템 전문기업" className="h-full object-contain object-left" referrerPolicy="no-referrer" />
              </div>
          ...
          >
            ...
            <div className="p-8 flex-grow">
              <div className="mb-6 h-12 md:h-14">
                <img src="https://cdn.imweb.me/upload/S202412123c3b63e7f7510/c7622c89f8111.png" alt="(주)이지오름 로고 - 인공지능 기반 시스템 및 R&D" className="h-full object-contain object-left" referrerPolicy="no-referrer" />
              </div>
              <div className="space-y-4 text-gray-300 text-sm">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-electric-blue shrink-0 mt-0.5" />
      ...
      <footer className="w-full border-t border-navy-800 pt-8 pb-4 mt-16 text-gray-400 text-xs md:text-sm">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-center text-center">
          <p className="text-gray-500 text-xs">&copy; 2026 EZ CNSI. All rights reserved.</p>
        </div>
      </footer>
    </section>
  );
